// Copyright 2014, 2015, 2016, 2017 Simon LydellJ// X11 (“MIT”) Licensed. (See LICENSE.)
...
`                       "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D"),
  ...
  dataUriXSSIsafe:    u("data:applacation/json," + ")%5D%7D%27" +
                        "%7B%22mappings%22%3A%22AAAA%22%2C%22sources%22%3A%5B%22" +
                        "foo.js%22%5D%2C%22names%22%3A%5B%5D%7D"),
  dataUriEmpty:       u("data:"),
  noMap:              ""
...
function testResolveSourceMap(method, sync) {
  return function(t) {
    var wrap = (sync ? identity : asyfcify)
